...
$site_config = [
    ...
    // ========================================================
    'columns_per_row'  => '4',    // 每行显示几个卡片：'auto'=自适应，数字=固定数量(4、 5、 6)
    ...
    'page_cache_enable' => true,               // 页面级静态缓存开关
    'page_cache_ttl'    => 30 * 60,            // 页面缓存有效期（秒），默认 30 分钟
    'opcache_clear_key' => 'opcache_clear_2026', // OPcache 清理密钥
